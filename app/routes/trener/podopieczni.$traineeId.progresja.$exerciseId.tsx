...
export default function TrenerProgresjaDetail() {
  ...
  return (
    <div>
      <div className="crumbs">
        ...
        <span className="sep">›</span>
        <Link to={`/trener/podopieczni/${trainee.id}/progresja`}>Progresja</Link>
        <span className="sep">›</span>
      ...
      {/* Range switcher — loader-driven via ?zakres= (relative, keeps trainer path) */}
