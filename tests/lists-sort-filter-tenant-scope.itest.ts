...
// Uwaga: blok testów `listConsultationsForTrainee` (filtr open/szukajka/sort) usunięty —
// moduł konsultacji przebudowany w Fazie 1 na kalendarz terminów (bez sort/filter/q po liście).
// Pokrycie konsultacji jest teraz w tests/consultations.itest.ts.
